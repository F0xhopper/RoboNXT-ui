RoboNXT is a simple schedule management application UI built with React. The app allows users to manage and edit different schedules, each containing a series of operations.
